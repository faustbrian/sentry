...
final class CleanCommand extends Command
{
     ...
     * options are given, both unassigned and orphaned abilities are removed.
     */
     ...
     *
     * @param Builder<Ability> $query      the query to scope
     ...
     *
     * @param  string $entityType the morph type or class name to instantiate
