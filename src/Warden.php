...
final class Warden
{
     ...
     *
     * @param  iterable<Role|string>|Role|string $roles The role(s) to assign
     * @return AssignsRoles                      Conductor for completing the role assignment
     */
    public function assign(iterable|Role|string $roles): AssignsRoles
    {
     ...
     *
     * @param  array<Role|string>|Collection<int, Role|string>|Role|string $roles The role(s) to remove
     * @return RemovesRoles                                                Conductor for completing the role removal
     */
    public function retract(array|Collection|Role|string $roles): RemovesRoles
    {
