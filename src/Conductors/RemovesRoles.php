...
final readonly class RemovesRoles
{
     ...
     *
     * @param array<Role|string>|Collection<int, Role|string>|Role|string $roles Single role identifier, array of identifiers,
     *                                                                           or collection of roles to be removed. Accepts
     *                                                                           Role models or string names which will be
     *                                                                           resolved to database IDs.
     */
    public function __construct(array|Collection|Role|string $roles)
    {
        /** @var array<Role|string> $rolesArray */
     ...
     * batch operations by accepting an array of authorities, grouping them
     * by class for efficient bulk removal queries.
     *
     * @param array<Model>|int|Model $authority single authority Model, authority ID, or array
     *                                          of authorities from which to remove the roles
     */
     ...
     *
     * @param array<int>        $roleIds        array of role primary keys to detach
