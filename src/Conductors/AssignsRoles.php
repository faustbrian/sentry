...
final class AssignsRoles
{
     ...
     *
     * Accepts roles in various formats (names, IDs, models, collections) and
     * normalizes them into an array for processing during assignment.
     *
     * @param iterable<Role|string>|Role|string $roles Role identifier(s) in any supported format
     */
    public function __construct(iterable|Role|string $roles)
    {
        /** @var array<Role|string> $normalizedRoles */
