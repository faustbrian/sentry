...
final class HandlesOwnership
{
     ...
     *                                                                                        constraints when this object destructs
     * @param Model|string                                                        $model      The model class or instance to which ownership applies.
     *                                                                                        Abilities will only be granted on instances owned by
     *                                                                                        the authority (typically determined by matching a
     *                                                                                        foreign key on the model to the authority's ID).
     * @param array<string, mixed>                                                $attributes additional pivot table attributes to store
     *                                                                                        with the ownership-restricted ability, such
     *                                                                                        as constraints or expiration metadata
     */
