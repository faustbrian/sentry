...
final class SyncsRolesAndAbilities
{
     ...
     *                                Can be a Model instance or string identifier that
     ...
     *
     * @param iterable<int|Role|string> $roles collection or array of role identifiers (IDs, names, or models)
     *                                         that should be assigned to the authority
     */
     ...
     *
     * @param array<int>                  $ids      array of pivot table IDs to remove from the relationship
     ...
     * attachment, ensuring proper constraint application.
     *
     ...
     *                                       flag to distinguish between granted and denied abilities
     */
