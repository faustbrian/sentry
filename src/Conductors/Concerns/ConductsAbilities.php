...
trait ConductsAbilities
{
     ...
     *
     * Returns true only when a single parameter is passed that is either a string
     * or a numerically-indexed array of strings. This enables the fluent API pattern
     ...
     *
     * @param  array<mixed>|int|Model|string $abilities Ability identifier(s) to be conducted lazily
     * @return LazyConductsAbilities         Lazy conductor for method chaining
     */
    protected function conductLazy(array|Model|int|string $abilities): LazyConductsAbilities
    {
